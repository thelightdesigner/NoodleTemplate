...
namespace NoodleTemplate
{
    ...
    public class BeatMap : ICloneable
    {
        ...
        [JsonConverter(typeof(TreeDictionaryJsonConverter))]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)] public TreeDictionary _customData { get; set; }
        ...
        public class Event : ICustomDataMapObject, ICloneable
        {
            ...
            [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)] public float? _time { get; set; }
            [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)] public Type? _type { get; set; }
            [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)] public Value? _value { get; set; }
            [JsonConverter(typeof(TreeDictionaryJsonConverter))]
            [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)] public TreeDictionary _customData { get; set; }
        ...
        public class Note : ICustomDataMapObject, ICloneable
        {
            ...
            public float GetTime() => float.Parse(_time.ToString());
            [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)] public float? _time { get; set; }
            [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)] public int? _lineIndex { get; set; }
            [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)] public int? _lineLayer { get; set; }
            [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)] public NoteType? _type { get; set; }
            [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)] public CutDirection? _cutDirection { get; set; }
            [JsonConverter(typeof(TreeDictionaryJsonConverter))]
            [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)] public TreeDictionary _customData { get; set; }
        ...
        public class Obstacle : ICustomDataMapObject, ICloneable
        {
            ...
            [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)] public int? _lineIndex { get; set; }
            [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)] public Type? _type { get; set; }
            [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)] public float? _duration { get; set; }
            [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)] public int? _width { get; set; }
            [JsonConverter(typeof(TreeDictionaryJsonConverter))]
            [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)] public TreeDictionary _customData { get; set; }
